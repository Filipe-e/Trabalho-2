                                                    ...
                                                    if(industria_atual->qtd_setores_na_planta > 0){
                                                            ...
                                                            if(setor_selecionado < industria_atual->qtd_setores_na_planta){
                                                                do{
                                                                    ...
                                                                    case 1:
                                                                        if(industria_atual->qtd_setores_na_planta > 0 && industria_atual->qtd_setores_na_planta > 0){
                                                                            if(setor_atual->qtd_sensores_no_setor < 3){
                                                                                ...
                                                                                printf("\033[31mNumero maximo de sensores no setor atingido\033[0m\n"); 
                                                                            }
                                                                            esperar_prosseguir();
                                                                        } 
                                                                        else{
